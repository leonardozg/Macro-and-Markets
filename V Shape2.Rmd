...
To identify a cycle we consider onlycritical dates coincidentfor both indexes than excludes: 2002/07/22 and 2009/02/23 from the S&P index.
...
```{r, echo=FALSE}
ggplot() + geom_density(data=df, aes(x=returnm, group=cycle, color=cycle), alpha=0.8, adjust=5)+ theme_classic()
```
